...
const lyrics = [
  {
    ...
    play: function () {
      playSong("music/TakeonMe.mp3", 32000, 10, 0.09);
    },
  ...
  {
    lyricSnippet:
      "Clock strikes upon the hour / And the sun begins to fade / Still enough time to figure out / How to chase my blues away / I've done alright up 'til now / It's the light of day that shows me how / And when the night falls / Loneliness calls", // I Wanna Dance with Somebody - Whitney Houston
    answers: [
  ...
  {
    lyricSnippet:
      "I come home, in the mornin' light / My mother says 'When you gonna live your life right?' / Oh momma dear, we're not the fortunate ones", // Girls Just Wanna Have Fun - Cyndi Lauper
    answers: [
  ...
  {
    lyricSnippet:
      "They told him, 'Don't you ever come around here' / 'Don't wanna see your face, you better disappear' / The fire's in their eyes and their words are really clear / So ...", // Beat it - Michael Jackson
    answers: [
  ...
  {
    lyricSnippet:
      " ... are made of this / Who am I to disagree / I travel the world and the seven seas / Everybody's looking for something / Some of them want to use you / Some of them want to get used by ...", // Sweet Dreams (Are Made of this) - Annie Lennox, Dave Stewart, and Eurthymics
    answers: [
      "Don't You (Forget About Me) by Simple Minds",
      "Under Pressure by Queen & David Bowie",
      "Sweet Dreams (Are Made of this) by Eurthymics",
      "Where Is My Mind? by the Pixies",
    ],
    play: function () {
      playSong("music/SweetDreams.mp3", 20000, 9, 0.09);
    },
    correctAnswer: "choiceC",
    incorrectAnswers: ["choiceA", "choiceB", "choiceD"],
    hasBeenPlayed: false,
  ...
  {
    lyricSnippet:
      "Woman, you want me, give me a sign / And catch my breathing even closer behind / Do do do do do do do dodo dododo dodo / In touch with the ground / I'm on the hunt I'm after you / Smell like I sound, I'm lost in a...", // Hungry Like the Wolf - Duran Duran
    answers: [
  ...
  {
    lyricSnippet:
      "Razzle 'n' a dazzle 'n' a flash a little light / Television lover, baby, go all night / Sometime, anytime, sugar me sweet / Little miss innocent sugar me, yeah, yeah / Now c'mon, take a bottle, shake it up / Break the bubble, break it up",
    ...
    play: function () {
      playSong("music/PourSomeSugarOnMe.mp3", 32000, 30, 0.09);
    },
    correctAnswer: "choiceB",
    incorrectAnswers: ["choiceA", "choiceC", "choiceD"],
    hasBeenPlayed: false,
  ...
  },
  {
    ...
    play: function () {
      playSong("music/RaspberryBeret.mp3", 32000, 30, 0.09);
    },
    correctAnswer: "choiceA",
    incorrectAnswers: ["choiceB", "choiceC", "choiceD"],
    hasBeenPlayed: false,
  ...
  {
    lyricSnippet:
      "Traveling in a fried-out Kombi / On a hippie trail, head full of zombie / I met a strange lady, she made me nervous / She took me in and gave me breakfast / And she ... ", // Down Under - Men at Work
    answers: [
  ...
  {
    lyricSnippet:
      "He turned to me as if to say / 'Hurry boy, it's waiting there for you' / It's gonna take a lot to drag me away from you / There's nothing that a hundred men or more could ever do / I bless the rains down in...", // Africa - Toto
    answers: [
...
function chooseAnswer(event) {
  ...
  if (correctAnswer === event.target.id) {
    ...
    guessListCorrect.innerHTML =
      "Encore! You have successfully named " +
    ...
    guessListIncorrect.innerHTML =
      "Uh-oh! You named " + incorrectGuesses.length + " tunes incorrectly!";
...
function finalScore() {
  ...
  if (correctGuesses.length <= 3) {
    ...
    displayLyrics.innerHTML =
      "You achieved '80s Garage Band' status! Keep strumming that air guitar, and increase your status next time!";
    performerStatusP.innerHTML = "NOT A WIN :( ";
  } else if (correctGuesses.length > 3 && correctGuesses.length <= 5) {
    guessListCorrect.innerHTML = "Final Score: ";
    guessListIncorrect.innerHTML = +correctGuesses.length + " OUT OF " + " 10";
    displayLyrics.innerHTML =
      "You achieved '80s Rising Star' status! Keep singing in the car and increase your status next time!";
    performerStatusP.innerHTML = "NOT A WIN :( ";
  } else if (correctGuesses.length > 5) {
    guessListCorrect.innerHTML = "Final Score: ";
    guessListIncorrect.innerHTML = +correctGuesses.length + " OUT OF " + " 10";
    displayLyrics.innerHTML =
      "You achieved '80s ICON' status! Keep selling out those shows until next time!";
    performerStatusP.innerHTML = "WINNER! :)";
  }
  resetButton.style.visibility = "visible";
  choiceList.style.backgroundColor = "#ffe5f5";
  instructions1.style.backgroundColor = "#ffe5f5";
  sideBarInstructions.style.backgroundColor = "#ffe5f5";
  resultMessage.style.backgroundColor = "#ffe5f5";

  choiceList.style.border = "none";
  instructions1.style.border = "none";
  sideBarInstructions.style.border = "none";
